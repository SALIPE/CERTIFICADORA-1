...
export default function VoluntarioLayout() {
  ...
  const handleEditUser = () => {
    navigate('/voluntario/perfil'); // Ajustado para a rota provável do voluntário
  };
      ...
      <Navbar bg="dark" variant="dark" expand="lg" sticky="top" className="shadow-sm py-3">
        <Container fluid>
          <Navbar.Brand href="#home" className="fw-bold fs-3 text-primary">
            TEDI <span className="text-light fs-6 fw-normal ms-2">| Painel do Voluntário</span>
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              {/* ESPAÇO P/ NAVEGAÇÃO ADD DO VOLUNTÁRIO */}
            </Nav>
            <Nav className="align-items-center">
              ...
              <NavDropdown
                title={<span className="btn btn-outline-light btn-sm">Menu Voluntário</span>}
